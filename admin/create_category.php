...
<html>
    ...
    <form action = "complete_category.php" method = "post" enctype="multipart/form-data">
        ...
        ?>
	        ...
	        <tr>
	            ...
	            <td><input type = "text" size="50" name = "nam"></td>
                <td><input type = "submit" value = "Добавить"></td>
	        </tr> 
	         
	        <tr>
	            <td><h4>Все доступные категории</h4></td>
            </tr>
...
<?php
    ...
    while ($a = mysql_fetch_array($ia))
    {
        echo "<tr><td>Раздел:<h4>" .$a[2] ."</h4> Категория:<h4>" .$a[1] ."</h4>";
        echo "<a href = \"../admin/delete_category.php?id=$a[0]\"><img src=\"../images/krestik.png\" alt = \"Удалить\" width = \"20\" height = \"20\"</a>";
        echo "</td></tr>";
    }
    echo "</table>";
?>
